...
function gridItemHov() {
    $('.grid-item img').mouseenter(function () {offset = $(this).offset()
...
$(document).ready(function()
{
    $(window).scroll(function()
    {
        ...
        if(scroll_top > 300)
        {
            $('[data-btn="toTop"]').addClass('to-top--fixed');
        }
        else
        {
            $('[data-btn="toTop"]').removeClass('to-top--fixed');
        }
    });
